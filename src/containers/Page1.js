        ...
        <div>
          <Card className="mb-5">
            ...
            <Card.Body>
              ...
              <Card.Text>
                React is one of (if not the most) popular JavaScript frontend framework. According to StackOverflow's
              ...
              <ListGroup className="mb-3">
                ...
                <ListGroup.Item>Easy to adopt and learn</ListGroup.Item>
              </ListGroup>
          ...
          <Card className="mb-5">
            ...
            <Card.Body>
              ...
              <ListGroup className="mb-3">
                ...
                <ListGroup.Item>Ability to share same piece of code with both server and client side</ListGroup.Item>
              ...
              <ListGroup className="mb-3">
                <ListGroup.Item>
                  Node.js doesn'nt provide scalability. One CPU is not going to be enough; the platform provides no
                  ability to scale out to take advantage of the multiple cores commonly present in today's server-class
                  hardware.
                </ListGroup.Item>
                <ListGroup.Item>Dealing with relational database is a pain if you are using Node.</ListGroup.Item>
