...
const Page3 = () => {
  return (
    <>
      ...
      >
        <Container>
          <h1 style={{ fontWeight: "bold" }}>How to create a webpage using React</h1>
        </Container>
      </div>
      <Container>
        <Row>
          ...
          >
            ...
            <div className="mb-4">
              ...
              <ol>
                ...
                <li>A code editor of your choice. VScode is a popular choice for most developers.</li>
                <li>
            ...
            <div className="mb-4">
              ...
              <div>
                ...
                <p>
                  ...
                  job applications to their profile. In order to do this we need a sign up and login form. We can create
                ...
                <p>
                  ...
                  determine which type of form and inputs to show based on if it's a sign up or login form.
                </p>
              ...
              <div>
                ...
                <p>
                  For each JobList component we will have have a title containing one of the 6 job phases using an h3
              ...
              <div>
                ...
                <p>
                  ...
                  determine which list/phase the form will save the job to.
                </p>
            ...
            <div className="mb-4">
              ...
              <ol>
                <li>
                  Create a a Node Js project running the following command:{" "}
